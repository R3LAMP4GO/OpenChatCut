...
function buildEditorWorkspaceViewProps(
  ...
  const { chatSeed, setChatSeed, showDesign, setShowDesign, showVersions, setShowVersions, showShortcuts, setShowShortcuts, shortcutApiRef, getPlayhead } = ui.dialogs;
  ...
  const { ingestToPool, importMobileUpload, importToPool, dropExternalFilesToTimeline, addMediaAssetsToTimeline, importToCanvas, pasteMediaAssets, useMediaAI, useTemplateAI } = ui.ingest;
