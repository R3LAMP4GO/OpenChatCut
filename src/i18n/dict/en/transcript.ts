...
export default {
  ...
  // TranscriptTakeReview
  '重录审阅': 'Take review',
  '转写工具': 'Transcript tools',
  '转写': 'Transcript',
  '重录': 'Takes',
  '正在查找重录…': 'Finding takes…',
  '查找重录': 'Find takes',
  '请在本地模型中安装转写复述匹配模型，以审阅改述内容。': 'Install the transcript take-matching model in Local models to review paraphrases.',
  '重录扫描失败': 'Take scan failed',
  '重试': 'Retry',
  '已达到扫描上限；请缩短片段后重新扫描。': 'Scan limit reached; shorten the clip and rescan.',
  '匹配的重录': 'Matched takes',
  '可能匹配（仅供审阅；不会删除任何词）': 'Possible match (review only; no words will be deleted)',
  '置信度': 'confidence',
  '预览': 'Preview',
  '保留此版本': 'Keep this take',
  '未找到可安全删除的匹配重录。': 'No safe matched takes found.',
  '确认删除重录': 'Confirm take deletion',
  '仅删除其他版本中已匹配的词吗？独有内容将保持不变。': 'Delete only the matched words from the other take(s)? Unique words stay unchanged.',
  '确认删除': 'Confirm deletion',
  '取消': 'Cancel',
  '已选择 {count} 个词': '{count} words selected',
  '删除所选词': 'Delete selected words',
